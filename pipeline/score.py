...
if __name__ == "__main__":
    cases = [
        ...
        Deal("t2", "Commercial Water Filtration Systems", "Manufactures and services water filtration systems sold to hospitals and health systems nationally. Recurring filter replacement contracts.", "axial", city="Cleveland", state="OH", revenue=2_100_000, ebitda=410_000, business_model_type="LOCATION_AGNOSTIC"),
        Deal("t3", "Regional Home Services Platform", "Leading residential HVAC and plumbing provider, strong management team in place.", "axial", city="Columbus", state="OH", revenue=12_000_000, ebitda=2_000_000, business_model_type="LOCAL_SERVICE"),
        Deal("t4", "Vertical SaaS for Contractors", "Software as a service platform, $3M ARR, 90% gross margin.", "newsletter", city="Dallas", state="TX", revenue=3_000_000, ebitda=900_000, business_model_type="LOCATION_AGNOSTIC"),
        Deal("t5", "Industrial Filter Media Manufacturer", "Manufacturer of filter media and cartridge filters, multi-year contract backlog with municipal water treatment plants.", "axial", city="Tulsa", state="OK", revenue=8_500_000, ebitda=1_400_000, business_model_type="LOCATION_AGNOSTIC"),
        ...
        Deal("t8", "Precision Machining Company", "Contract manufacturer, ships nationally, long-term agreement with aerospace primes. Largest customer 40% of revenue.", "axial", city="Phoenix", state="AZ", revenue=9_000_000, ebitda=1_600_000, business_model_type="LOCATION_AGNOSTIC"),
        ...
        Deal("t10", "Senior Living Facility Management Co", "Manages skilled nursing facility operations and long-term care facility services across three states.", "axial", city="Little Rock", state="AR", revenue=6_000_000, ebitda=520_000, business_model_type="LOCATION_AGNOSTIC"),
        ...
        Deal("t12", "Specialty Distribution Business", "Wholesale distributor of industrial consumables. Cash Flow reported.", "bizbuysell", city="Fort Worth", state="TX", revenue=5_000_000, ebitda=950_000, ebitda_is_sde=True, business_model_type="LOCATION_AGNOSTIC"),
    ]
