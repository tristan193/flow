...
export function NextDealActions({ deal, member }: { deal: NextDeal; member: MemberId }) {
  ...
  async function move(stage: NextStageId) {
    setBusy(true);
    setError(null);
    try {
...
function ActionButton({
  ...
  const idleTone = {
    ...
    discuss:
      "border-line bg-surface text-ink hover:border-discuss hover:bg-discuss-bg hover:text-discuss",
